...
export const state = () => ({
  events: [
    {
      name: 'Palisades Tahoe January Comp #1',
    ...
    {
      name: "Northstar Hornet's Mogul Rodeo",
      title: 'Jan 20-21, 2024',
      details: `<ul>
        <li>Training Friday 1/19/24</li>
        <li><a href="https://adminskiracing.com" target="new">Register @ adminskiracing.com</a></li>
        <li><a href="/files/jan-2024-hornet-program.pdf" target="new">Competition Fact Sheet</a></li>
        <li><a href="/files/jan-2024-hornet-schedule.pdf" target="new">Competition Schedule</a></li>
        </ul>`,
      start: '2024-01-20',
      end: '2024-01-21',
      color: 'blue'
    ...
    },
    {
      ...
      details:`<ul>
        <li><a href="https://adminskiracing.com" target="new">Register @ adminskiracing.com</a></li>
        <li><a href="/results/2022-12-17-singles-overall.pdf">Sat 12/17 Overall Results</a></li>
        <li><a href="/results/2022-12-17-singles-age-group.pdf">Sat 12/17 Results by Age Group</a></li>
        </ul>`,
      start: '2022-12-16',
      end: '2022-12-18',
      color: 'blue'
