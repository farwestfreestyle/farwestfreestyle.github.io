    ...
    <v-row>
      ...
      <v-col cols="12" md="8">
        ...
        <ul>
          ...
          <li><b>Sign up for a US Ski and Snowboard Membership</b> – Athletes must join at both the national and divisional levels (selecting FarWest Freestyle) to gain access to competitions in your home area and nationally.</li>
          <li>A Competitor’s membership is required and involves paying a FarWest Freestyle Division fee.</li>
          <li>Parents generally create a free US Ski and Snowboard account for themselves plus an account for each child. Once each account is created, the child’s account can be linked to the parent’s account from where memberships and competition registrations are managed. A simple tutorial on setting up accounts is available here.</li>
